...
DO i=1, nmol
    ...
    CALL h5dwrite_f(dataset_id, H5T_NATIVE_FLOAT, dot1(i,:), ERROR_FLAG)
    ...
    CALL h5dcreate_f(file_id, trim(dataset_name), H5T_NATIVE_REAL, dataspace_id, dataset_id, ERROR_FLAG)
    CALL h5dwrite_f(dataset_id, H5T_NATIVE_FLOAT, eoh1(i,:,:), ERROR_FLAG)
    ...
    CALL h5dcreate_f(file_id, trim(dataset_name), H5T_NATIVE_REAL, dataspace_id, dataset_id, ERROR_FLAG)
    CALL h5dwrite_f(dataset_id, H5T_NATIVE_FLOAT, dot2(i,:), ERROR_FLAG)
    ...
    WRITE(dataset_name, '(A, I0)') "eoh_", (i-1)*2+1
    CALL h5dcreate_f(file_id, trim(dataset_name), H5T_NATIVE_REAL, dataspace_id, dataset_id, ERROR_FLAG)
    CALL h5dwrite_f(dataset_id, H5T_NATIVE_FLOAT, eoh2(i,:,:), ERROR_FLAG)
